...
public class ButterflyAnalystPagePlugin implements IAnalystPagePlugin<IButterfly>, AnalystPageBiology.IBiologyPlugin<IButterfly>, AnalystPageBehaviour.IBehaviourPlugin<IButterfly> {
	@Override
	...
	public void addAnalystPages(IButterfly individual, IWidget parent, IArea pageSize, List<ITitledWidget> analystPages) {
		...
		analystPages.add(new AnalystPageBehaviour<>(parent, pageSize, individual, this));
	}
