...
public class ConfigurationMain implements IConfigurable {
	...
	public void configure(Configuration config) {
		...
		waterHiveRate = config.getFloat("waterHiveRate", WORLDGEN, waterHiveRate, 0.0F, 10.0F, "Sets the worldgen spawn chance for water hives.");
		rockHiveRate = config.getFloat("rockHiveRate", WORLDGEN, rockHiveRate, 0.0F, 10.0F, "Sets the worldgen spawn chance for rock hives.");
		netherHiveRate = config.getFloat("netherHiveRate", WORLDGEN, netherHiveRate, 0.0F, 10.0F, "Sets the worldgen spawn chance for nether hives.");
		marbleHiveRate = config.getFloat("marbleHiveRate", WORLDGEN, marbleHiveRate, 0.0F, 10.0F, "Sets the worldgen spawn chance for marble hives.");
	}
}
