		...
		this.addSelfEventHandler(new EventMouse.Down.Handler() {
			...
			public void onEvent(final EventMouse.Down event) {
				if (ControlSlot.this.slot != null) {
					...
					playerController.windowClick(windowId, slotNumber, button, GuiScreen.isShiftKeyDown() ? 1 : 0, ((Window) ControlSlot.this.getSuperParent()).getGui().getMinecraft().thePlayer);
				}
			}
		});
	}
