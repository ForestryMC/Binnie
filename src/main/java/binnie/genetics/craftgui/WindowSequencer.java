...
public class WindowSequencer extends WindowMachine {
	...
	public void initialiseClient() {
		...
		x = 34;
		y = 92;
		slotText = new ControlText(this, new IArea(0.0f, y, w(), 12.0f), EnumChatFormatting.DARK_GRAY + I18N.localise(Genetics.instance, "machine.sequencer.gui.willNotSave"), TextJustification.MiddleCenter);
		y += 20;
