...
public class WindowSequencer extends WindowMachine {
	...
	public void recieveGuiNBT(Side side, EntityPlayer player, String name, NBTTagCompound nbt) {
		if (side == Side.CLIENT && name.equals("username")) {
			slotText.setValue(EnumChatFormatting.DARK_GRAY + "Genes will be sequenced by " + nbt.getString("username"));
		}
	...
	public void initialiseClient() {
		...
		x = 34;
		y = 92;
		slotText = new ControlText(this, new IArea(0.0f, y, w(), 12.0f), EnumChatFormatting.DARK_GRAY + "Userless. Will not save sequences", TextJustification.MiddleCenter);
		y += 20;
