...
public class WindowAnalyst extends Window {
	...
	public void initialiseClient() {
		...
		analystPanel = new Panel(this, 16.0f, 54.0f, 280.0f, 164.0f, MinecraftGUI.PanelType.Outline) {
			...
			public void initialise() {
				...
				leftPage = new ControlScrollableContent<IWidget>(this, 3.0f, 3.0f, sectionWidth + 2.0f, h() - 8.0f + 2.0f, 0.0f) {
					@Override
					public void onRenderBackground() {
						if (getContent() == null) {
							return;
	...
	public void onWindowInventoryChanged() {
		...
		if (getWindowInventory().getStackInSlot(0) != null && !Analyser.isAnalysed(getWindowInventory().getStackInSlot(0))) {
