...
public class AnalystPageBiology extends ControlAnalystPage {
	...
	public AnalystPageBiology(IWidget parent, IArea area, IIndividual ind) {
		...
		if (ind instanceof IBee) {
			...
			new ControlTextCentered(this, y, EnumChatFormatting.ITALIC + I18N.localise("genetics.gui.analyst.biology.sappiness", alleleName))
				.setColor(getColor());
			y += 20;
		} else {
			y += 10;
		...
		if (ind instanceof IBee) {
			...
			if (fertility > 1) {
				new ControlTextCentered(this, y, EnumChatFormatting.BOLD + I18N.localise("genetics.gui.analyst.biology.fertility.drones", fertility))
					.setColor(getColor());
			} else {
				new ControlTextCentered(this, y, EnumChatFormatting.BOLD + I18N.localise("genetics.gui.analyst.biology.fertility.drone"))
					.setColor(getColor());
			}
			...
			new ControlTextCentered(this, y, EnumChatFormatting.BOLD + getMCDayString(lifespan * (bee.getGenome().getNocturnal() ? 1.0f : 2.0f)))
				.setColor(getColor());
			y += 22;
		}
		...
		if (ind instanceof IButterfly) {
			...
			if (fertility > 1) {
				new ControlTextCentered(this, y, I18N.localise("genetics.gui.analyst.biology.fertility.moths", fertility))
					.setColor(getColor());
			} else {
			...
			y += 12;
			new ControlTextCentered(this, y, EnumChatFormatting.BOLD + I18N.localise("genetics.gui.analyst.biology.blocksPerSec", speed))
				.setColor(getColor());
			y += 22;
		}
		...
		if (ind instanceof ITree) {
			...
			if (fertility > 1) {
				new ControlTextCentered(this, y, I18N.localise("genetics.gui.analyst.biology.fertility.leaves", fertility))
					.setColor(getColor());
			} else {
			...
			new ControlTextCentered(this, y, I18N.localise("genetics.gui.analyst.biology.mothSpawn.perLeaf", getTimeString(butterflySpawn)))
				.setColor(getColor());
			...
			for (EnumPlantType type : tree.getGenome().getPlantTypes()) {
				new ControlTextCentered(this, y, EnumChatFormatting.ITALIC + type.name())
					.setColor(getColor());
				y += 12;
			}
		}
		if (ind instanceof IFlower) {
			...
			new ControlTextCentered(this, y, I18N.localise("genetics.gui.analyst.biology.mothSpawn", getTimeString(butterflySpawn2)))
				.setColor(getColor());
			y += 30;
			...
			new ControlTextCentered(this, y, EnumChatFormatting.BOLD + getMCDayString(lifespan2))
				.setColor(getColor());
			y += 22;
			...
			new ControlTextCentered(this, y, EnumChatFormatting.ITALIC + I18N.localise("genetics.gui.analyst.biology.perLifetime", (int) (floweringLifespan / dispersalTime)))
				.setColor(getColor());
			y += 22;
			...
			new ControlTextCentered(this, y, EnumChatFormatting.ITALIC + I18N.localise("genetics.gui.analyst.biology.perLifetime", (int) (floweringLifespan / pollinateTime)))
				.setColor(getColor());
			y += 22;
		}
