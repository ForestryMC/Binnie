...
public class AnalystPageDescription extends ControlAnalystPage {
	public AnalystPageDescription(IWidget parent, IArea area, IIndividual ind) {
		...
		y += 16;
		new ControlTextCentered(this, y, species.getName() + EnumChatFormatting.RESET)
			.setColor(getColor());

		y += 10;
		new ControlTextCentered(this, y, EnumChatFormatting.ITALIC + branchBinomial + " " + species.getBinomial() + EnumChatFormatting.RESET)
			.setColor(getColor());
		...
		y += 26;
		ControlText descText = new ControlText(this, new IArea(8.0f, y, w() - 16.0f, 0.0f), descBody.toString() + EnumChatFormatting.RESET, TextJustification.TOP_CENTER);
