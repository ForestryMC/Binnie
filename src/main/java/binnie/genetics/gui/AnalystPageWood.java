...
public class AnalystPageWood extends AnalystPageProduce {
	public AnalystPageWood(IWidget parent, IArea area, ITree ind) {
		...
		if (products.size() > 0) {
			new ControlTextCentered(this, y, I18N.localise("genetics.gui.analyst.wood.logs"))
				.setColor(getColor());
			y += 10;
		...
		if (products.size() == 0) {
			new ControlTextCentered(this, y, I18N.localise("genetics.gui.analyst.wood.noFruits"))
				.setColor(getColor());
			y += 28;
		}
