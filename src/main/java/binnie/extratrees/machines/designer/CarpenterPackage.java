...
public abstract class CarpenterPackage extends ExtraTreeMachine.PackageExtraTreeMachine implements IMachineInformation {
	...
	public void createMachine(Machine machine) {
		...
		inventory.addSlot(Designer.GLUE_SLOT, "polish")
			.setValidator(new PolishSlotValidator(type));

		inventory.addSlot(Designer.DESIGN_1_SLOT, "wood")
			.setValidator(new PlanksSlotValidator(type));

		inventory.addSlot(Designer.DESIGN_2_SLOT, "wood")
			.setValidator(new PlanksSlotValidator(type));
