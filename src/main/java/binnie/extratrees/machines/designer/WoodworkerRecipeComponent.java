...
public class WoodworkerRecipeComponent extends ComponentRecipe implements
	IComponentRecipe,
	INetwork.GuiNBT,
	IErrorStateSource {
	...
	public ErrorState canWork() {
		if (getUtil().isSlotEmpty(Designer.GLUE_SLOT)) {
			return new ErrorState.NoItem(I18N.localise("extratrees.machine.worker.error.glueRequired"), Designer.GLUE_SLOT);
		}
		return null;
	}
