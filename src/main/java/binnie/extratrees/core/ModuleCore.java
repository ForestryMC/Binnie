			...
			while (!logQueue.isEmpty()) {
				...
				for (int i = 0; i < 4; ++i) {
					...
					if (wood5 == null) {
						...
						String img = "<img alt=\"" + wood5.getName() + "\" src=\"images/logs/" + wood5.toString().toLowerCase() + "Bark.png\">";
			...
			while (!plankQueue.isEmpty()) {
				...
				for (int i = 0; i < 4; ++i) {
					...
					if (wood2 == null) {
						...
						String img = "<img alt=\"" + wood2.getName() + "\" src=\"images/planks/" + wood2.getName() + ".png\">";
