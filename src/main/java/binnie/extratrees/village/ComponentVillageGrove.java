...
public class ComponentVillageGrove extends StructureVillagePieces.Village {
	...
	public ComponentVillageGrove(StructureVillagePieces.Start start, int type, Random rand, StructureBoundingBox boundingBox, int coordBaseMode) {
		super(start, type);
		this.coordBaseMode = coordBaseMode;
		this.boundingBox = boundingBox;
	}

	public static StructureBoundingBox func_74904_a(StructureVillagePieces.Start start, List pieces, Random rand, int p_74904_3_, int p_74904_4_, int p_74904_5_, int p_74904_6_) {
