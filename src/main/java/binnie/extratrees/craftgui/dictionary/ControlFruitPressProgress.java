...
public class ControlFruitPressProgress extends ControlProgressBase {
	...
	public void onRenderBackground() {
		...
		ItemStack input = window.getContainer().getSlotFromInventory(window.getInventory(), Press.slotCurrent).getStack();
		...
		GL11.glDisable(3042);
		CraftGUI.Render.iconItem(new IPoint(4.0f, 52.0f), input.getIconIndex());
	}
