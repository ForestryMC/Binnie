...
public class ExtraTreeFruitGene implements IAlleleFruit, IFruitProvider {
	...
	public static void init() {
		...
		ExtraTreeFruitGene.KeyLime.addProduct(Food.KEY_LIME.get(1), 1.0f);
		...
		ExtraTreeFruitGene.FingerLime.addProduct(Food.FINGER_LIME.get(1), 1.0f);
		...
		ExtraTreeFruitGene.BuddhaHand.addProduct(Food.BUDDHA_HAND.get(1), 1.0f);
		...
		ExtraTreeFruitGene.CherryPlum.addProduct(Food.CHERRY_PLUM.get(1), 1.0f);
		...
		ExtraTreeFruitGene.WildCherry.addProduct(Food.WILD_CHERRY.get(1), 1.0f);
		ExtraTreeFruitGene.WildCherry.setFamily(familyPrune);
		ExtraTreeFruitGene.SourCherry.addProduct(Food.SOUR_CHERRY.get(1), 1.0f);
		ExtraTreeFruitGene.SourCherry.setFamily(familyPrune);
		ExtraTreeFruitGene.BlackCherry.addProduct(Food.BLACK_CHERRY.get(1), 1.0f);
		...
		ExtraTreeFruitGene.RedBanana.addProduct(Food.RED_BANANA.get(2), 1.0f);
		...
		ExtraTreeFruitGene.BrazilNut.addProduct(Food.BRAZIL_NUT.get(4), 1.0f);
		...
		ExtraTreeFruitGene.GingkoNut.addProduct(Food.GINGKO_NUT.get(1), 1.0f);
		...
		ExtraTreeFruitGene.OsangeOsange.addProduct(Food.OSANGE_ORANGE.get(1), 1.0f);
		...
		ExtraTreeFruitGene.GoldenRaspberry.addProduct(Food.GOLDEN_RASPBERRY.get(2), 1.0f);
		...
		ExtraTreeFruitGene.StarAnise.addProduct(Food.STAR_ANISE.get(1), 1.0f);
