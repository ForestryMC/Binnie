...
public class DesignBlock {
	...
	public String toString() {
		return super.toString() + " { design:" + design + " }, { primary:" + primaryMaterial + " }, { secondary:" + secondaryMaterial + " }, { rotation:" + rotation + " }, { facing:" + facing + " }";
	}
	...
	public String getString() {
		...
		if (getPrimaryMaterial() != getSecondaryMaterial()) {
			type = I18N.localise("extratrees.block.tooltip.twoMaterials", getPrimaryMaterial().getName(), getSecondaryMaterial().getName());
		} else {
			type = getPrimaryMaterial().getName();
		}
		return super.toString() + " " + "{" + type + " " + getDesign().getName() + " " + (panel ? "Panel" : "Tile") + ", Facing:" + getFacing().toString() + ", Rotation:" + getRotation() + "}";
	}
}
