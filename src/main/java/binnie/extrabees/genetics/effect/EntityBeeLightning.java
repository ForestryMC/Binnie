	...
	public void onUpdate() {
		...
		if (lightningState >= 0) {
			if (worldObj.isRemote) {
				...
				double offset = 3.0;
				List list = worldObj.getEntitiesWithinAABBExcludingEntity(this, AxisAlignedBB.getBoundingBox(posX - offset, posY - offset, posZ - offset, posX + offset, posY + 6.0 + offset, posZ + offset));
