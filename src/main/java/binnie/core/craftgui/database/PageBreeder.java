...
public class PageBreeder extends ControlPage<DatabaseTab> {
	...
	public void onPageRefresh() {
		...
		new ControlTextCentered(this, 115.0f, I18N.localise("binniecore.gui.database.branch.count", system.discoveredBranchCount, system.totalBranchCount));
		new ControlBreedingProgress(this, 20, 127, 102, 14, system, system.discoveredBranchPercentage);

		if (system.discoveredSecretCount > 0) {
			new ControlTextCentered(this, 155.0f, I18N.localise("binniecore.gui.database.species.secretCount", system.discoveredSecretCount, system.totalSecretCount));
		}
