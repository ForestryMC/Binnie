...
import binnie.core.machines.transfer.*;
import binnie.craftgui.controls.*;
import binnie.craftgui.controls.button.*;
import binnie.craftgui.controls.core.*;
import binnie.craftgui.controls.page.*;
import binnie.craftgui.controls.scroll.*;
import binnie.craftgui.controls.tab.*;
...
import binnie.craftgui.resource.*;
import binnie.craftgui.resource.minecraft.*;
import binnie.craftgui.window.*;
...
public class WindowCompartment extends WindowMachine implements IWindowAffectsShiftClick {
	...
	public void initialiseClient() {
		this.setTitle(Machine.getMachine(getInventory()).getPackage().getDisplayName());
		int x = 16;
		int y = 32;
			...
			public ControlTab<Integer> createTab(float x, float y, float w, float h, Integer value) {
				return new ControlTabIcon<Integer>(this, x, y, w, h, value) {
					...
					public ItemStack getItemStack() {
						return WindowCompartment.this.getTab(value).getIcon();
					}

					@Override
					public String getName() {
						return WindowCompartment.this.getTab(value).getName();
					}

					@Override
					public int getOutlineColour() {
						return WindowCompartment.this.getTab(value).getColor().getColour();
					}
		...
		tabIcon.addAttribute(Attribute.MouseOver);
